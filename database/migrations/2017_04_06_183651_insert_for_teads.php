...
class InsertForTeads extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        VALUES
            (23,'Teads','TeadsController',NULL,'Email',NULL,'start','income_converted_usd',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);");
    ...
    {
        DB::delete('delete from line_item where source_id = 23;');
        DB::delete('delete from source where source_id = 23;');
    }
}
