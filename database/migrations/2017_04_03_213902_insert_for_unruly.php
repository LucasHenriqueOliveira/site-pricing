...
class InsertForUnruly extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        VALUES
            (10,'Unruly','UnrulyController',NULL,'Page',NULL,'Video Impressions','Earnings ($)',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);");
    ...
    {
        DB::delete('delete from line_item where source_id = 10;');
        DB::delete('delete from source where source_id = 10;');
    }
}
