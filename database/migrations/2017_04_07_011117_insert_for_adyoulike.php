...
class InsertForAdyoulike extends Migration
{
    /**
     * Run the migrations.
     *
...
VALUES
    (7,'AdYouLike',NULL,NULL,'Page',NULL,'INSERTION','PricePublisher',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);");
    }
    ...
    {
        DB::delete('delete from line_item where source_id = 7;');
        DB::delete('delete from source where source_id = 7;');
    }
}
