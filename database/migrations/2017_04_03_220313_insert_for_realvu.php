...
class InsertForRealvu extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        VALUES
            (11,'Realvu','RealvuController',NULL,'Page',NULL,'req','grv',NULL,NULL,NULL,'name',NULL,NULL,NULL,NULL,NULL,NULL);");
    ...
    {
        DB::delete('delete from line_item where source_id = 11;');
        DB::delete('delete from source where source_id = 11;');
    }
}
