...
class InsertForPadsquad extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        VALUES
            (20,'Padsquad','PadSquadController',NULL,'API',NULL,'impressions','publisher_revenue',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);");
    }
    ...
    {
        DB::delete('delete from line_item where source_id = 20;');
        DB::delete('delete from source where source_id = 20;');
    }
}
